        ...
        <form method="POST" action="{{ route('admin.volunteers.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="role" class="form-control" value="{{ old('role') }}" placeholder="e.g. Usher, Sound, Registration">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Shift</label>
                    <input type="text" name="shift" class="form-control" value="{{ old('shift') }}" placeholder="e.g. Morning, Afternoon">
                </div>
                <div class="col-md-6">
            ...
            <div class="form-check mb-3">
                <input type="checkbox" name="is_confirmed" id="is_confirmed" class="form-check-input" value="1" {{ old('is_confirmed') ? 'checked' : '' }}>
